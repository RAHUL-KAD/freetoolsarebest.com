...
const NumberConverter: React.FC = () => {
    ...
    return (
        <div className="py-2">
            <Head>
                <title>Convert numbers to text (Indonesian) | freetoolsarebest </title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Header />
            <div className='p-4 lg:px-[5.5rem] md:px-10 flex flex-col items-center justify-center'>
                <h1 className="text-3xl font-bold text-center mt-5 mb-5">Convert numbers to text (Indonesian)</h1>
