...
const NumberConverter: React.FC = () => {
    ...
    const convertToText = (num: number): string => {
        ...
        for (let i = 18; i >= 0; i -= 3) {
            ...
            if (quotient > 0) {
                if (quotient >= 100) {
                    text += unitsMap[Math.floor(quotient / 100)] + 'hundred ';
                    quotient %= 100;
                }
    ...
    return (
        <div className="py-2">
            <Head>
                <title>Convert numbers to text (Danish) | freetoolsarebest </title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Header />
            <div className='p-4 lg:px-[5.5rem] md:px-10 flex flex-col items-center justify-center'>
                <h1 className="text-3xl font-bold text-center mt-5 mb-5">Convert numbers to text (Danish)</h1>
