...
const ImageConverter: React.FC = () => {
    ...
    const downloadBase64AsTextFile = () => {
        if (base64String) {
            ...
            link.href = url;
            link.setAttribute('download', 'jpeg_to_base64_ftools.txt');
    ...
    return (
        <div className="py-2">
            <Head>
                <title>JPEG to Base64 Converter | freetoolsarebest </title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Header />
            <div className='p-4 lg:px-[5.5rem] md:px-10 flex flex-col items-center justify-center'>
                <h1 className="text-3xl font-bold text-center mt-5 mb-5">JPEG to Base64 Converter</h1>
