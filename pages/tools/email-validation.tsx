            ...
            <main className="flex max-w-7xl justify-center flex-col items-center px-4">
                ...
                <div className="mt-10 ">
                    <form className="flex items-center max-w-[600px]" onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className="inline-flex lg:ml-10 items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
                            Verify
                        </button>
                    </form>
