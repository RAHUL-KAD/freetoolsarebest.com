...
const Convert: React.FC = () => {
    ...
    const convertToImage = () => {
        try {
            if (base64String) {
                const image = `data:image/tiff;base64,${base64String}`; // Changed to TIFF
                setImageSrc(image);
                setError('');
            } else {
    ...
    const downloadImage = () => {
        if (imageSrc) {
            ...
            link.href = imageSrc;
            link.download = 'converted_image.tiff'; // Changed to TIFF
    ...
    return (
        <div className="py-2">
            <Head>
                <title>Base64 to TIFF Converter | freetoolsarebest </title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Header />
            <div className='p-4 lg:px-[5.5rem] md:px-10 flex flex-col items-center justify-center'>
                <h1 className="text-3xl font-bold text-center mt-5 mb-5">Base64 to TIFF Converter</h1>
                ...
                {imageSrc && (
                    <div className="mt-8">
                        <h2 className="text-xl font-semibold mb-2">Converted TIFF:</h2>
                        <button
