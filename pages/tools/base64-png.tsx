...
const Convert: React.FC = () => {
    ...
    return (
        ...
        //   {imageSrc && (
        //     <div className="mt-4">
        //       <img src={imageSrc} alt="Converted" className="max-w-full" />
        //     </div>
        //   )}
        // </div>
        ...
        <div className="py-2">
            <Head>
                <title>Base64 to PNG Converter | freetoolsarebest </title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Header />
            <div className='p-4 lg:px-[5.5rem] md:px-10 flex flex-col items-center justify-center'>
                <h1 className="text-3xl font-bold text-center mt-5 mb-5">Base64 to PNG Converter</h1>
                ...
                {imageSrc && (
                    <div className="mt-8">
                        <h2 className="text-xl font-semibold mb-2">Converted PNG:</h2>
                        <button
